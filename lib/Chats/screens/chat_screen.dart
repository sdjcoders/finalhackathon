...
import 'package:tripsathihackathon/chats/helper/my_date_util.dart';


import 'package:tripsathihackathon/models/chat_user.dart';
import 'package:tripsathihackathon/models/message.dart';
import 'package:tripsathihackathon/chats/widgets/message_card.dart';
import 'package:tripsathihackathon/chats/screens/view_profile_screen.dart';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Widget build(BuildContext context) {
    mq = MediaQuery.of(context); // Assign MediaQuery data
